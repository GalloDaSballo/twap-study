...
contract ExampleTwapTest is Test {
    ...
    function _compare() internal {
        ...
        console2.log(twapReference.timeToAccrue(), twapOptimized.timeToAccrue(), "timeToAccrue();");
        console2.log(twapReference.getRealValue(), twapOptimized.getRealValue(), "getRealValue();");
        console2.log(twapReference.getRealValue(), twapOptimized.getRealValue(), "getRealValue();");
    }
