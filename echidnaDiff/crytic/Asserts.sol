...
abstract contract Asserts {
    ...
    //     t(isEqual, abi.encodePacked(reason1, " OR ", reason2));
    // }
    ...
    //     t(isEqual, abi.encodePacked(reason1, " OR ", reason2, " OR ", reason3));
    // }
    ...
    //     t(isEqual, abi.encodePacked(reason1, " OR ", reason2, " OR ", reason3, " OR ", reason4));
    // }
}
